      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg border border-gray-100 p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full border border-gray-300 rounded-md px-4 py-2.5 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transiton-colors"
                placeholder="••••••••"
              />
              <button
                type="button"
          ...
          <motion.button whileTap={{ scale: 0.98 }}
            type="submit"
            disabled={loading}
            className={`rounded-sm w-full py-2.5 cursor-pointer px-4 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-md shadow-sm transition-colors mt-2 ${loading ? "opacity-70 cursor-not-allowed" : ""}`}
          >
